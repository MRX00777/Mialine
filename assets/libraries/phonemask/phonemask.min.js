		...
		function l(p, b, w) {
			var C = {
					...
					try {
						...
						return (
							n && -1 === navigator.appVersion.indexOf("MSIE 10")
								? ((t = n.createRange()).moveStart("character", -C.val().length),
								  (a = t.text.length))
								: (!s && "0" !== s) || (a = s),
							a
						);
				...
				events: function () {
					p.on("keydown.mask", function (t) {
						p.data("mask-keycode", t.keyCode || t.which),
							p.data("mask-previus-value", p.val()),
							p.data("mask-previus-caret-pos", C.getCaret()),
						...
						.on("blur.mask", function () {
							o === C.val() || p.data("changed") || p.trigger("change"),
								p.data("changed", !1);
						})
						.on("blur.mask", function () {
							o = C.val();
				...
				val: function (t) {
					var a = p.is("input") ? "val" : "text",
						e = 0 < arguments.length ? (p[a]() !== t && p[a](t), p) : p[a]();
					return e;
				},
				calculateCaretPosition: function (t) {
					...
					if (t !== a) {
						for (
							var n,
								s = p.data("mask-previus-caret-pos") || 0,
								r = a.length,
								o = t.length,
								i = 0,
								l = 0,
								...
								k = 0,
								k = e;
							k < r && C.maskDigitPosMap[k];
							k++
						)
							l++;
						for (k = e - 1; 0 <= k && C.maskDigitPosMap[k]; k--) i++;
						for (k = e - 1; 0 <= k; k--) C.maskDigitPosMap[k] && c++;
						for (k = s - 1; 0 <= k; k--) C.maskDigitPosMapOld[k] && u++;
						o < e
							? (e = 10 * r)
							: e <= s && s !== o
							? C.maskDigitPosMapOld[e] ||
							  ((n = e), (e -= u - c), (e -= i), C.maskDigitPosMap[e] && (e = n))
							: s < e && ((e += c - u), (e += l));
					}
					return e;
				},
				behaviour: function (t) {
					...
					if (-1 === i.inArray(a, j.byPassKeys)) {
						var e = C.getMasked(),
							n = C.getCaret(),
							s = p.data("mask-previus-value") || "";
						return (
							setTimeout(function () {
								C.setCaret(C.calculateCaretPosition(s));
					...
					for (
						...
						m
							? (g.match(m.pattern)
									...
									: C.invalid.push({ p: l, v: g, e: m.pattern }),
							  (l += u))
							: (t || s[k](v),
							  g === v ? (f.push(l), (l += u)) : ((n = v), f.push(l + d), d++),
							  (o += u));
					}
					var M = b.charAt(e);
					i !== c + 1 || j.translation[M] || s.push(M);
					var y = s.join("");
					return C.mapMaskdigitPositions(y, f, c), y;
				},
				...
				callbacks: function (t) {
					...
					a("onChange", !0 == n, s),
						a("onKeyPress", !0 == n, s),
						a("onComplete", e.length === b.length, s),
						a("onInvalid", 0 < C.invalid.length, [e, t, p, C.invalid, w]);
				},
			};
			p = i(p);
			var r,
			...
			(b = "function" == typeof b ? b(C.val(), void 0, p, w) : b),
				...
				(j.remove = function () {
					var t = C.getCaret();
					return (
						j.options.placeholder && p.removeAttr("placeholder"),
						p.data("mask-maxlength") && p.removeAttr("maxlength"),
						C.destroyEvents(),
						C.val(j.getCleanVal()),
						C.setCaret(t),
						p
				...
				(j.init = function (t) {
					if (
						...
						w.placeholder && p.attr("placeholder", w.placeholder),
							p.data("mask") && p.attr("autocomplete", "off");
						...
						e && p.attr("maxlength", b.length).data("mask-maxlength", !0),
							C.destroyEvents(),
							C.events();
						var s = C.getCaret();
