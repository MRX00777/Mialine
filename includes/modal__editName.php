...
<div id="modal___name" class="popup popup__contracts-name modal__edit-name">
    <div class="popup__body-name">
        <form action="" class="popup__content">
            <div class="pupup__title">Изменить имя</div>
            <button type="reset" class="constracts__name-close edit__name-close">
            ...
            <div class="popup__form">
                <div class="info__fill_input">
                    <div class="input">
                        <p>Ваше имя</p>
                        <input type="text" placeholder="Евгения" required>
                    </div>
                    <div class="modal__buttons">
                        <button type="reset" class="balance__btn-reset edit__name-reset">Отмена</button>
                        <button type="submit" class="balance__btn-save edit__name-save">Сохранить</button>
                    </div>
                </div>
            </div>
        </form>
